...
# ================================================
# RDT Evaluation Script for LIBERO Spatial Tasks
# ================================================
...
# 显示配置信息
echo "=========================================="
echo "   RDT LIBERO Spatial Evaluation"
echo "=========================================="
...
# ⚠️ 重要：修改这里的模型路径
MODEL_PATH="/share_data/zhukefei/siqi_rdt/best_checkpoints/libero_spatial_best_ckpt/libero_spatial_best_ckpt"
